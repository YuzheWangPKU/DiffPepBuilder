...
"""Modified pipeline of restrained Amber minimization."""

import io
import time
from typing import Collection, Optional, Sequence, Dict, Any, Tuple
import numpy as np
from absl import logging
from analysis import cleanup
...
def _assert_equal_nonterminal_atom_types(
...
def _check_atom_mask_is_ideal(prot):
    ...
    _assert_equal_nonterminal_atom_types(atom_mask, ideal_atom_mask)
